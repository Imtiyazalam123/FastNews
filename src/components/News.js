...
export default class News extends Component {
 ...
 async componentDidMount() {
    console.log("cdm")
    let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=3965f7e2c33342b09f4a558c330a7f5a"
      ...
      <div className='container my-3'>
        ...
        <div className="row">
          {this.state.articles.map((element) => {
            ...
            <NewsItem title={element.title ? element.title.slice(0, 48)+"...": "there is no title"} description={element.description?element.description.slice(0, 120)+"...":"there is no description"} imageUrl={element.urlToImage} newsUrl={element.url}/>
           </div>
          })}
